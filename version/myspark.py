...
if __name__ == "__main__":
	...
	lines = sc.textFile('hdfs://namenode.omnilab.sjtu.edu.cn/user/wanghaiyang/mobile_utf8/0819.csv', 1)
	...
	output = counts.saveAsTextFile("./cityfunction/0819_user_count.csv")
...
# 	output = counts.saveAsTextFile("./0819_ext_full.csv")
...
# 	import fileinput
# 	sc = SparkContext('spark://namenode.omnilab.sjtu.edu.cn:7077',appName="Extract")
# 	lines = sc.textFile('hdfs://namenode.omnilab.sjtu.edu.cn/user/qiangsiwei/move.txt', 1)
# 	counts = lines.map(lambda x : extract(x))
# output = counts.saveAsTextFile("./move_statistic.csv")
